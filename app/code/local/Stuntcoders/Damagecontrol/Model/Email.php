...
class Stuntcoders_Damagecontrol_Model_Email extends Mage_Core_Model_Abstract
{
    ...
    public function generateCode()
    {
        ...
        throw new Exception('Unable to generate damage control code');
    }
    ...
    public function sendOrderReviewMail()
    {
        if ($this->getOrderId()) {
            Mage::getModel('core/email_template')->sendTransactional(
                Mage::helper('stuntcoders_damagecontrol')->getReviewMailTemplate(),
                Mage::helper('stuntcoders_damagecontrol')->getReviewMailSender(),
    ...
    public function sendNotificationEmail()
    {
        if ($this->getOrderId()) {
            Mage::getModel('core/email_template')->sendTransactional(
                Mage::helper('stuntcoders_damagecontrol')->getNotificationMailTemplate(),
                Mage::helper('stuntcoders_damagecontrol')->getNotificationMailSender(),
                Mage::helper('stuntcoders_damagecontrol')->getNotificationMailRecipients(),
                null,
                array(
                    'order' => $this->getOrder(),
                    'review' => $this
