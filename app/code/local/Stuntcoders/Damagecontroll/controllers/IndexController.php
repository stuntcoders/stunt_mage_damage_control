...
class Stuntcoders_Damagecontroll_IndexController extends Mage_Core_Controller_Front_Action
{
    public function indexAction()
    {
        ...
        $reviewId = Mage::getSingleton('stuntcoders_damagecontroll/email')
            ->getResource()
        ...
        Mage::register('sc_damage_controll', $review);
    ...
    public function setMarkAction()
    {
        ...
        $review = Mage::getModel('stuntcoders_damagecontroll/email')->load($code, 'code');
    ...
    public function setCommentAction()
    {
        ...
        try {
            $review = Mage::getModel('stuntcoders_damagecontroll/email')
                ->load($code, 'code');
